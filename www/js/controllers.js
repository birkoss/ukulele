ukuleleApp.controller('NotesFavoritesCtrl', function($scope, $filter, $state, $ionicSideMenuDelegate, NotesFavoritesService, NotesService, NotesFavoritesService, ConfigService) {
